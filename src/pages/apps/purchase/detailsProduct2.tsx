...
const DetailsPurchase2 = ({ product }: any) => {
  ...
  const handleInputChange = (e: any, index: number) => {
    ...
    list[index]['Total'] =  (list[index]?.Count * list[index]?.Price * ((100 - list[index]?.DiscountNegotiated) / 100)).toFixed(2) || 0;
    setInputList(list);
...
export default DetailsPurchase2;